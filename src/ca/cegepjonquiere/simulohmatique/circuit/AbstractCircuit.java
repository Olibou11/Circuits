...
public abstract class AbstractCircuit implements IComposant {
    ...
    public String toString(){
        ...
        composants.stream().filter(Objects::nonNull).forEachOrdered(composant -> string[0] += "(" + composant.calculerResistance() + " Ω, " + composant.calculerTension() + " V, " + composant.calculerCourant() + "A), ");
        return string[0] + " Circuit Total: " + "(" + calculerResistance() + " Ω, " + calculerTension() + " V, " + calculerCourant() + "A) " + "\n";
    }
}